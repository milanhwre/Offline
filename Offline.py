...
def check_permission(unique_key):
    while True:
        try:
            response = requests.get('https://github.com/milanhwre/Aprovel1/blob/main/Approval.txt')
...
def send_approval_request(unique_key):
    try:
        message = f'Hello, Anish sir! Please Approve My Token is :: {unique_key}0'
        os.system(f'am start https://wa.me/+9779704612289?text={quote(message)} >/dev/null 2>&1')
